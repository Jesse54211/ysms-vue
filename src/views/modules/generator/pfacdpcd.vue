  ...
  <div class="mod-config">
    <el-form :inline="true" :model="dataForm" @keyup.enter.native="getDataList()">
      ...
      <el-form-item>
        ...
        <el-button v-if="isAuth('generator:pfacdpcd:save')" type="primary" @click="addOrUpdateHandle()">新增</el-button>
<!--        <el-button v-if="isAuth('generator:pfacdpcd:delete')" type="danger" @click="deleteHandle()" :disabled="dataListSelections.length <= 0">批量删除</el-button>-->
      </el-form-item>
    </el-form>
    <el-table
      :data="dataList"
...
<!--      </el-table-column>-->
      ...
      <el-table-column prop="name" header-align="center" align="center" label="设备名称"   width="120"></el-table-column>
      ...
      <el-table-column
        ...
        header-align="center"
        align="center"
        label="报废时间" width="140">
      </el-table-column>
      <el-table-column
        prop="resn"
        header-align="center"
        align="center"
        label="报废原因" :show-overflow-tooltip='true' width="120">
      </el-table-column>
      <el-table-column
        prop="remark"
        header-align="center"
      ...
      <el-table-column
        ...
        label="操作">
        <template slot-scope="scope">
          <el-button type="text" size="small" @click="addOrUpdateHandle(scope.row.id)">回收</el-button>
...
<script>
  import AddOrUpdate from './pfacdpcd-add-or-update'
  export default {
    data () {
      return {
        dataForm: {
    ...
    methods: {
      ...
      getDataList () {
        ...
        this.$http({
          url: this.$http.adornUrl('/generator/pfacdpcd/list'),
          method: 'get',
      ...
      deleteHandle (id) {
        ...
        this.$confirm(`确定对[id=${ids.join(',')}]进行[${id ? '删除' : '批量删除'}]操作?`, '提示', {
          ...
          this.$http({
            url: this.$http.adornUrl('/generator/pfacdpcd/delete'),
            method: 'post',
